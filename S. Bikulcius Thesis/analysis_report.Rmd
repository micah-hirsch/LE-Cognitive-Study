...
m3 <- glmmTMB(peak_pupil ~ trial_c + speaker + scale(list_sort_c) + (1|subject) + (1|code), data = accurate_df)
sjPlot::tab_model(m3)
...
m3b <- glmmTMB(peak_pupil ~ trial_c + speaker + scale(list_sort_c) + (1|subject), data = accurate_df)
...
m4 <- glmmTMB(peak_pupil ~ trial_c + speaker + scale(flanker_c) + (1|subject), data = accurate_df)
...
m5 <- glmmTMB(peak_pupil ~ trial_c + speaker + scale(card_sort_c) + (1|subject), data = accurate_df)
...
m6 <- glmmTMB(peak_pupil ~ trial_c + speaker + scale(pattern_c) + (1|subject), data = accurate_df)
...
m7 <- glmmTMB(peak_pupil ~ trial_c + speaker + scale(list_sort_c)*speaker + (1|subject), data = accurate_df)
...
m8 <- glmmTMB(peak_pupil ~ trial_c + speaker + scale(list_sort_c)*speaker + scale(flanker_c)*speaker + (1|subject), data = accurate_df)
...
m9 <- glmmTMB(peak_pupil ~ trial_c + speaker + scale(list_sort_c)*speaker + scale(card_sort_c)*speaker + (1|subject), data = accurate_df)
...
m10 <- glmmTMB(peak_pupil ~ trial_c + speaker + scale(list_sort_c)*speaker + scale(pattern_c)*speaker + (1|subject), data = accurate_df)
